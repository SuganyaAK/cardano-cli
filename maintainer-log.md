...
| Date | Repo | Source | Item | Action Taken | Outcome | Link | Category |
|------|------|--------|------|--------------|---------|------|----------|
...
Track patterns worth flagging to the core team even if only one instance has surfaced so far.

| First noticed | Theme | Times seen | Status |
|----------------|-------|------------|--------|
| 2026-09-01 | CLI/node version mismatch causing `kes-period-info` failures | 1 | Closed on 2026-09-02 |
| | | | |